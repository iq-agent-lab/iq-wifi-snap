...
export const storage = {
  ...
  addHistory: (entry) => {
    ...
    const merged = {
      ...
      speedMbps: existing?.speedMbps ?? entry.speedMbps ?? null,
      latencyMs: existing?.latencyMs ?? entry.latencyMs ?? null,
      speedAt: existing?.speedAt ?? entry.speedAt ?? null,
