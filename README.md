...
- [x] **v0.4** — 브랜드 리디자인 (Wifi Snap), 새 로고, 커스텀 삭제 확인, 카메라 권한 상태 표시, PWA 설치 흐름 개선 (iOS Safari 가이드 / standalone 감지)
- [ ] v0.5 — 카톡 SDK 직접 공유, 캡티브 포털 자동 통과 보조
- [ ] v0.6 — 온디바이스 OCR 폴백 (Tesseract.js · 오프라인 상황)
